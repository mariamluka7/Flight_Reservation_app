...
top_strip =ctk.CTkFrame(root,height=80,fg_color='#756AB6',corner_radius=0)
top_strip.pack(fill='x',side='top') 

app_title = ctk.CTkLabel(root,text='ROMA Reservations ✨',text_color='#F2FCFC',bg_color="#756AB6",font=("Segoe UI",28,'bold'))
app_title.place(x=50,y=20)
#---------------------------------------------------------------------------------

#-------creating navigation button in strip---------------------------------------
home_lbl = ctk.CTkLabel(root,text='Home',text_color='#F2FCFC',font=('Segoe UI',18),cursor='hand2',bg_color='#756AB6')
...
#------
booking_lbl = ctk.CTkLabel(root,text='Book Flight',text_color='#F2FCFC',font=('Segoe UI',18),cursor='hand2',bg_color='#756AB6')
...
#------
viewReserv_lbl = ctk.CTkLabel(root,text='View Reservations',text_color='#F2FCFC',font=('Segoe UI',18),cursor='hand2',bg_color='#756AB6')
...
wlcm_lbl = ctk.CTkLabel(root,text='Welcome to ROMA Reservations',text_color='#645CAA',font=('Segoe UI',42,'bold'))
...
book_frame = ctk.CTkFrame(root,width=450,height=300,corner_radius=10,border_width=2,border_color='#756AB6',fg_color="white")
...
viewing_frame = ctk.CTkFrame(root,width=450,height=300,corner_radius=10,border_width=2,border_color='#756AB6',fg_color='white')
